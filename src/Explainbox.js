      ...
      <ExpansionPanel>
        ...
        <ExpansionPanelDetails>
          <Typography>
            ...
            <br></br>
            ３つある変換方法から選んでファイルを選択を押し、変換してください。下ではそれぞれの違いについて説明します。正直自分はは何が違うのかさっぱりです。数式は導入がめんどくさかったので書きません。言葉の意味もめんどくさいので書きません。あとディレクトリとかコードとかは色々あれなので、できれば見ないでおいてもらえるとありがたいです。
            <br></br>
            <br></br>
            <h2>Sobelフィルタ</h2>
